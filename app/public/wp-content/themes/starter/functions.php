...
function acf_new_item_block() {
	...
	if( function_exists('acf_register_block') ) {
		...
		acf_register_block(array(
			'name'				=> 'new-item',
			'title'				=> __('New Item'),
			'description'		=> __('A custom block for new items.'),
			'render_template'	=> 'template-parts/blocks/new-item/block-new-item.php',
			'category'			=> 'layout',
			'icon'				=> 'excerpt-view',
			'keywords'			=> array( 'new' ),
		));
...
add_action('acf/init', 'acf_new_item_block');